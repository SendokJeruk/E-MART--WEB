<template>
  <!-- Komponen Card Produk: Menampilkan ringkasan informasi produk -->
...
<script setup>
// Menerima data produk dan nama toko sebagai input
defineProps({
...
<style>
/* Mengimpor font khusus untuk judul */
