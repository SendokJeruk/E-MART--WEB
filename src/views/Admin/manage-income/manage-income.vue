<template>
  <AdminSide>
    <div class="p-6">
      ...
      <!-- Jika tidak ada data -->
      <div v-if="withdraws.length === 0" class="p-6 text-center text-gray-500">
            ...
            >
              ...
              <div class="space-y-2 text-sm text-gray-700">
                ...
                <p>
                  ...
                  Rp {{ selectedWithdraw.jumlah.toLocaleString() }}
                </p>
                <p><span class="font-semibold">Metode:</span> {{ selectedWithdraw.metode }}</p>
                <p>
                  <span class="font-semibold">Rekening Tujuan:</span>
                  {{ selectedWithdraw.rekening_tujuan }}
                </p>
